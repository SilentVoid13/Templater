...
| `{{tp_today}}` | - `f`: Format for the date, refer to [format reference](https://momentjs.com/docs/#/displaying/format/) (default: `YYYY-MM-DD`).<br />- `offset`: Offset for the day, for example you can set this to `-7` to get last week's date (default: `0`). | Retrieves today's date + the date offset argument if given | `2021-01-15` |
