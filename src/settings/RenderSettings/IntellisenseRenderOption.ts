 ...
 */
export function shouldRenderReturns(
    render_setting: IntellisenseRenderOption | boolean,
): boolean {
    // Render override
 ...
 */
export function shouldRenderParameters(
    render_setting: IntellisenseRenderOption,
): boolean {
    // Render override
    if (isBoolean(render_setting)) return render_setting;
